    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <div className="mb-8">
            <Shield className="w-16 h-16 text-yellow-500 mx-auto animate-pulse" />
          </div>
          <h1 className="text-2xl font-bold text-yellow-500 mb-2">AUTHENTICATION SUCCESSFUL</h1>
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden dark">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4">
        ...
        {/* Subtle affiliate banner below login */}
        <div className="mt-4">
