...
const ClassifiedVault = () => {
  ...
  const predefinedKeys = [
    { name: 'SIGNAL_API_URL', description: 'MarktBit Signal Engine API URL', category: 'API_KEYS' },
    { name: 'STOCK_API_URL', description: 'MarktBit Stock API URL', category: 'API_KEYS' },
    { name: 'TELEGRAM_BOT_TOKEN', description: 'Telegram Bot Token for signal notifications', category: 'API_KEYS' },
    { name: 'TELEGRAM_CHAT_ID', description: 'Telegram Chat ID for signal routing', category: 'API_KEYS' },
    { name: 'BINANCE_API_KEY', description: 'Binance API Key for exchange data', category: 'API_KEYS' },
    { name: 'BINANCE_API_SECRET', description: 'Binance API Secret for exchange data', category: 'API_KEYS' },
    { name: 'ALPHA_VANTAGE_API_KEY', description: 'Alpha Vantage API Key for stock market data', category: 'API_KEYS' },
    { name: 'POLYGON_API_KEY', description: 'Polygon.io API Key for stock market data', category: 'API_KEYS' },
    { name: 'COINGECKO_API_KEY', description: 'CoinGecko API Key for crypto data', category: 'API_KEYS' },
