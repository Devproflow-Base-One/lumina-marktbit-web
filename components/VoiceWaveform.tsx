  ...
  const drawWaveform = () => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        ...
        gradient.addColorStop(0, 'var(--color-semantic-success)')
        gradient.addColorStop(0.5, 'var(--color-semantic-info)')
      ...
      <div className="absolute bottom-2 left-2 flex items-center gap-2">
        {isListening ? (
          <>
            ...
            <span className="text-xs text-yellow-400">Recording...</span>
          </>
        ) : (
          <>
