...
// Map components — removed PropertyMap and LocationPicker (property CRM remnants)
...
export const DynamicLocationPicker = dynamic(
  // @ts-ignore - Component not yet implemented
  () => import('@/components/ui/LocationPicker').then(mod => ({ default: mod.LocationPicker })),
  {
    loading: LoadingSpinner,
    ssr: false,
  }
...
export const createDynamicComponent = <T extends ComponentType<any>>(
  ...
  return dynamic(async () => {
    try {
      ...
      if (exportName && typeof importedModule === 'object' && importedModule !== null) {
        const component = (importedModule as any)[exportName]
        if (!component) {
...
export default dynamicComponentsExport
