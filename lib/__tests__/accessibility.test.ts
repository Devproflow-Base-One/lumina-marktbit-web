...
describe('Accessibility Utilities', () => {
  ...
  it('should generate accessibility summary', () => {
    const mockReport = {
      violations: [
        { id: 'v1', impact: 'critical' as const, description: 'Critical issue', help: 'Fix it', helpUrl: 'https://example.com', nodes: [] as any[] },
        { id: 'v2', impact: 'serious' as const, description: 'Serious issue', help: 'Fix it', helpUrl: 'https://example.com', nodes: [] as any[] }
      ],
      passes: 10,
      incomplete: 2,
      inapplicable: 5,
  ...
  it('should check WCAG compliance - A level with serious issues', () => {
    const mockReport = {
      violations: [
        { id: 'v1', impact: 'serious' as const, description: 'Serious issue', help: 'Fix it', helpUrl: 'https://example.com', nodes: [] as any[] }
      ],
      passes: 10,
      incomplete: 0,
      inapplicable: 0,
  ...
  it('should provide accessibility recommendations', () => {
    const mockReport = {
      violations: [
        { id: 'v1', impact: 'serious' as const, description: 'Serious issue', help: 'Fix the contrast', helpUrl: 'https://example.com', nodes: [] as any[] }
      ],
      passes: 10,
      incomplete: 0,
      inapplicable: 0,
