export const tokens = {
  colors: {
    // Primary colors (Yellow — Crypto Gold branding)
    primary: {
      50: '#fefce8',
      100: '#fef9c3',
      200: '#fef08a',
  ...
  shadows: {
    ...
    dark: {
      ...
      glowYellow: '0 0 20px rgb(234 179 8 / 0.5)',
    },
  },
  ...
  animation: {
    ...
    keyframes: {
      ...
      glow: {
        '0%, 100%': { boxShadow: '0 0 5px rgb(234 179 8 / 0.5)' },
        '50%': { boxShadow: '0 0 20px rgb(234 179 8 / 0.8)' },
      },
      glowPulse: {
        '0%, 100%': { boxShadow: '0 0 5px rgb(234 179 8 / 0.3)' },
        '50%': { boxShadow: '0 0 25px rgb(234 179 8 / 0.6)' },
      },
    },
  },
